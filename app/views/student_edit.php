<div class="container fade-in">
    <h1>Edit Student</h1>
    <form method="post" action="<?= site_url('students/update/'.$students['id']) ?>">
        <label for="first_name">First Name</label>
        <input type="text" id="first_name" name="first_name" value="<?= htmlspecialchars($students['first_name']) ?>" required>

        <label for="last_name">Last Name</label>
        <input type="text" id="last_name" name="last_name" value="<?= htmlspecialchars($students['last_name']) ?>" required>

        <label for="email">Email</label>
        <input type="email" id="email" name="email" value="<?= htmlspecialchars($students['email']) ?>" required>
